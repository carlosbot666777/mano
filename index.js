...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN: SOLRAC MODS\n'
            + 'ORG:Owner SOLRAC;\n'
            + 'TEL;type=CELL;type=VOICE;waid=5588981321692:+55 88981321692\n'
            + 'END:VCARD'

prefix = "!"
name = "~ SOLRAC BOY"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM TEMENTE SOLRAC😁"
rmenu = "SOLRAC KARAY:)"
limitt = 10
ban = []
userpremium = ["5588981321692@s.whatsapp.net"] //ubah nomer kalian
		...
		case 'daftar':
			...
			if (isBanned) return reply(mess.only.benned)
				...
				ben = '```Lista Banido``` :\n'
					...
					break 
				case 'premiumlist':
				prem = '```Lista de Premium SOLRAC MODS``` :\n'
